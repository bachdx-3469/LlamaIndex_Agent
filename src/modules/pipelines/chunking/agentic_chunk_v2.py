...
from src.modules.components.prompts.chunking_v2 import CHUNKING_PROMPT_TMPL
from src.modules.components.parser import LLMSherpaParser
from src.modules.components.parser.llmsherpa import DEFAULT_LLMSHERPA_API_URL
...
class AgenticChunkPipelineV2(BaseChunkPipeline):
    def __init__(self,
                 **kwargs):
        self.parser = LLMSherpaParser(DEFAULT_LLMSHERPA_API_URL)
    ...
    def run(self,
        ...
        chunks = self.parser.parse_file(
            ...
            category=category)
        text = "".join(txt for txt in chunks)
